...
func _show_home() -> void:
    _ensure_build_mode(); _close_contextual_tools()
...
func _activate_project(project) -> bool:
    ...
    if workspace_screen.has_method("get_play_session") and terrain_controller != null:
        workspace_screen.get_play_session().configure_streaming(Callable(terrain_controller, "update_streaming_focus"))
    return true
