...
@onready var vertex_button: Button = %VertexButton
...
func _ready() -> void:
    ...
    vertex_button.toggled.connect(_emit_toggle.bind(&"vertex"))
...
func focus_primary() -> void: place_button.grab_focus()
func set_history_state(can_undo: bool, can_redo: bool) -> void: undo_button.disabled = not can_undo; redo_button.disabled = not can_redo
func set_group_enabled(enabled: bool) -> void: group_button.disabled = not enabled
func _emit_action(action: StringName) -> void: action_requested.emit(action, true)
func _emit_toggle(enabled: bool, action: StringName) -> void: action_requested.emit(action, enabled)

func _configure_focus() -> void:
    var buttons: Array[Button] = [place_button, grid_button, surface_button, vertex_button, object_button, socket_button, ground_button, group_button, undo_button, redo_button]
