...
func _run() -> void:
    ...
    multiplayer_layer.call("refresh_state"); multiplayer_layer.call("open_panel")
    await _settle(); await _capture("01-multiplayer-full")
    ...
    multiplayer_layer.call("refresh_state"); multiplayer_layer.call("open_panel")
    await _settle(); await _capture("02-host-armed-full")
    ...
    multiplayer_layer.call("refresh_state"); multiplayer_layer.call("open_panel")
    await _settle(); await _capture("03-join-armed-compact")
