...
def main() -> int:
    ...
    bundled_templates = package_dir / "tools" / "export_templates" / "4.7.1.stable"; bundled_templates.mkdir(parents=True)
    ...
    manifest = {"schema_version": 1, "product_name": product["product_name"], "version": version, "channel": product["channel"], "source_commit": args.source_commit, "authoritative_base_commit": product["base_commit"], "godot_version": godot_version, "platform": "Windows", "architecture": "x86_64", "package_name": package_name, "build_timestamp": build_time, "included_files": manifest_files(package_dir)}
