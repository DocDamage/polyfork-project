...
const COLORWAYS = {
  ...
  'galvanised':  { foot: 0x4e5459, collar: 0x6b7278, post: 0x8a9197, head: 0xa9afb4, lens: 0x2e3134 },
  'charcoal':    { foot: 0x1b1d20, collar: 0x3c4145, post: 0x4e5459, head: 0x8a9197, lens: 0x2e3134 },
  'moss-green':  { foot: 0x2e3134, collar: 0x2f6b4f, post: 0x3f8a5e, head: 0xc7cbcc, lens: 0x1b1d20 },
  'cream':       { foot: 0x8c7355, collar: 0xb9a88c, post: 0xe4e2dc, head: 0xf2efe7, lens: 0x3c4145 },
};
...
export const params = {
  ...
  lens: {
    type: 'color', default: 0x2e3134, label: 'Glazing',
    describe: 'albedo of the four recessed glass panels and the diffuser under the '
      + 'lantern. Dark slate by day; this is the zone that burns warm at night, so keep '
      + 'it clearly darker than the frame around it or the lamp reads as unglazed.',
  },
  tallness: {
...
export function createAsset(userParams = {}) {
  ...
  const parts = [];
  const addPart = (g, c) => { if (g.length) parts.push({ g: posGeo(g), c }); };
